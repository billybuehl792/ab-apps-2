...
import { clientCreateSchema } from "@/store/schemas/clients";
import { errorUtils } from "@/store/utils/error";
import type { TClientCreate } from "@/store/types/clients";

interface IClientCreateFormProps extends Omit<
  StackProps<"form">,
  "onSubmit" | "onReset"
> {
  onSubmit: SubmitHandler<TClientCreate>;
  onSubmitInvalid?: SubmitErrorHandler<TClientCreate>;
  onFormStateChange?: (formState: FormState<TClientCreate>) => void;
  slotProps?: {
    fields?: StackProps;
    actions?: StackProps;
...
const ClientCreateForm: React.FC<IClientCreateFormProps> = ({
  onSubmit,
  onSubmitInvalid,
  onFormStateChange,
  slotProps,
