...
export const contactDocumentMutations = (
  id: TContact["id"],
  dId: TDocument["id"],
) => ({
  ...
  delete: mutationOptions({
    ...
    mutationFn: contactEndpoints.contact(id).documents().document(dId).delete,
  }),
});

export const contactDocumentsMutations = (id: TContact["id"]) => ({
  create: mutationOptions({
    mutationKey: ["contacts", "contact", id, "documents", "create"] as const,
    mutationFn: contactEndpoints.contact(id).documents().post,
  }),
  delete: mutationOptions({
    mutationKey: ["contacts", "contact", id, "documents", "delete"] as const,
    mutationFn: (dId: TContact["id"]) =>
      contactEndpoints.contact(id).documents().document(dId).delete(),
  }),
  document: (dId: TDocument["id"]) => contactDocumentMutations(id, dId),
});

export const contactMutations = (id: TContact["id"]) => ({
  update: mutationOptions({
  ...
  documents: contactDocumentsMutations(id),
});
